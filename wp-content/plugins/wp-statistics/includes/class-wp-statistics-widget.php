...
class WP_Statistics_Widget extends \WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        if ($widget_options['useronline_widget']) {
            echo '<li>';
            echo '<label>' . __('Đang truy cập', 'wp-statistics') . ':&nbsp;</label>';
        ...
        if ($widget_options['tvisit_widget']) {
            echo '<li>';
            echo '<label>' . __('Truy cập hôm nay', 'wp-statistics') . ':&nbsp;</label>';
        ...
        if ($widget_options['mvisit_widget']) {
            echo '<li>';
            echo '<label>' . __('Truy cập 30 ngày trước', 'wp-statistics') . ':&nbsp;</label>';
        ...
        if ($widget_options['ttvisit_widget']) {
            echo '<li>';
            echo '<label>' . __('Tổng lượng truy cập', 'wp-statistics') . ':&nbsp;</label>';
        ...
        if ($widget_options['tp_widget']) {
            echo '<li>';
            echo '<label>' . __('Tổng số bài viết', 'wp-statistics') . ':&nbsp;</label>';
        ...
        if ($widget_options['tc_widget']) {
            echo '<li>';
            echo '<label>' . __('Tổng số bình luận', 'wp-statistics') . ':&nbsp;</label>';
