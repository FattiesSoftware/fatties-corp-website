	...
	*/
	...
	function submit_deactivation_response() {
		if ( ! isset( $_POST['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field( $_POST['_wpnonce'] ), '_cool-plugins_deactivate_feedback_nonce' ) ) {
			...
			$plugin_initial    = get_option('aacgfe_initial_save_version') ?: 'N/A';
            $install_date      = get_option('aacgfe-install-date') ?: 'N/A';
			...
			$response          = wp_remote_post(
				...
				array(
					'timeout' => 30,
					'body'    => array(
						'server_info' => serialize(\AACGFE_Widget_Addon::aacgfe_get_user_info()['server_info']),
                        'extra_details' => serialize(\AACGFE_Widget_Addon::aacgfe_get_user_info()['extra_details']),
